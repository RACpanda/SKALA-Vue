import { i as __toESM, n as __commonJSMin, t as getHot } from "./hot-Dg2gqCo9.js";
import { $ as useAttrs, A as createCommentVNode, B as nextTick, C as Fragment, D as computed, F as getCurrentInstance, G as openBlock, H as onMounted, L as h, M as createTextVNode, N as createVNode, O as createBaseVNode, P as defineComponent, Q as resolveDynamicComponent, R as inject, V as onBeforeUnmount, X as renderSlot, Y as renderList, Z as resolveComponent, _t as normalizeClass, a as isStaticMode, at as withAsyncContext, bt as toDisplayString, d as onKeyDown, et as useSlots, g as useRouter, gt as unref, h as useRoute, ht as toValue, i as safeJsonParse, it as watchEffect, j as createElementBlock, k as createBlock, lt as customRef, m as tryOnScopeDispose, mt as toRefs, n as guessMode, o as onModuleUpdated, ot as withCtx, q as provide, r as inspectSourcemaps, rt as watch, s as rpc, st as withDirectives, t as usePayloadStore, tt as useTemplateRef, ut as ref, x as vShow, yt as normalizeStyle } from "./index-D7rIWszL.js";
...
import { n as DurationDisplay_default, t as useOptionsStore } from "./options-rRuuQb58.js";
import { n as ModuleId_default, r as kt, t as ModuleList_default } from "./ModuleList-CQMIXl1I.js";
//#region node_modules/.pnpm/splitpanes@4.1.2_vue@3.5.35_typescript@6.0.3_/node_modules/splitpanes/dist/splitpanes.esm.js
var y = /* @__PURE__ */ Object.assign({ inheritAttrs: !1 }, {
	...
	setup(n, { emit: r }) {
		let a = r, s = n, p = useAttrs(), h$1 = useSlots(), y = ref([]), b = computed(() => y.value.reduce((e, t) => (e[~~t.id] = t) && e, {})), x = computed(() => y.value.length), S = ref(null), C = ref(!1), w = ref({
			mouseDown: !1,
			dragging: !1,
			activeSplitter: null,
			cursorOffset: 0
			...
			Array.from(S.value?.children || []).some((n) => (n.className.includes("splitpanes__pane") && t++, n.isSameNode(e.el))), y.value.splice(t, 0, {
				...e,
				index: t
			}), y.value.forEach((e, t) => e.index = t), C.value && !J && (J = !0, nextTick(() => {
			...
			y.value.forEach((e, t) => e.index = t), nextTick(() => {
		...
		watch(() => s.firstSplitter, () => K()), watch(() => s.horizontal, (e) => nextTick(() => {
			a("direction-changed", {
				horizontal: e,
				panes: y.value.map((e) => ({
					min: e.min,
		...
		return provide("panes", y), provide("indexedPanes", b), provide("horizontal", computed(() => s.horizontal)), provide("requestUpdate", q), provide("onPaneAdd", Y), provide("onPaneRemove", X), provide("onPaneClick", P), (e, n) => (openBlock(), createBlock(resolveDynamicComponent(ae)));
	}
}), b = {
	__name: "pane",
	props: {
	...
	setup(t) {
		let i = t, o = inject("requestUpdate"), d = inject("onPaneAdd"), m = inject("horizontal"), g = inject("onPaneRemove"), _ = inject("onPaneClick"), y = getCurrentInstance()?.uid, b = inject("indexedPanes"), x = computed(() => b.value[y]), S = ref(null), C = computed(() => {
		...
		}), onBeforeUnmount(() => g(y)), (e, t) => (openBlock(), createElementBlock("div", {
			ref_key: "paneEl",
			ref: S,
			class: "splitpanes__pane",
			onClick: t[0] ||= (t) => unref(_)(t, e._.uid),
			style: normalizeStyle(E.value)
		}, [renderSlot(e.$slots, "default")], 4));
	}
};
//#endregion
//#region node_modules/.pnpm/codemirror@5.65.20/node_modules/codemirror/lib/codemirror.js
var require_codemirror = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	(function(global, factory) {
		...
		Delayed.prototype.onTimeout = function(self) {
			self.id = 0;
			if (self.time <= +/* @__PURE__ */ new Date()) self.f();
			else setTimeout(self.handler, self.time - +/* @__PURE__ */ new Date());
		};
		...
		var bidiOrdering = (function() {
			...
			return function(str, direction) {
				...
				for (var i$6 = 0; i$6 < len; ++i$6) if (isNeutral.test(types[i$6])) {
					...
					var replace$1 = before == ((end$1 < len ? types[end$1] : outerType) == "L") ? before ? "L" : "R" : outerType;
		...
		function markedSpansBefore(old, startCh, isInsert) {
			...
			if (old) for (var i = 0; i < old.length; ++i) {
				...
				if (span.from == null || (marker.inclusiveLeft ? span.from <= startCh : span.from < startCh) || span.from == startCh && marker.type == "bookmark" && (!isInsert || !span.marker.insertLeft)) {
		...
		function markedSpansAfter(old, endCh, isInsert) {
			...
			if (old) for (var i = 0; i < old.length; ++i) {
				var span = old[i], marker = span.marker;
				if (span.to == null || (marker.inclusiveRight ? span.to >= endCh : span.to > endCh) || span.from == endCh && marker.type == "bookmark" && (!isInsert || span.marker.insertLeft)) {
		...
		function stretchSpansOverChange(doc, change) {
			...
			if (last) for (var i$1 = 0; i$1 < last.length; ++i$1) {
				...
				if (span$1.from == null) {
					if (!getMarkedSpanFor(first, span$1.marker)) {
						span$1.from = offset;
		...
		function getUsefulRect(rects, bias) {
			var rect = nullRect;
			if (bias == "left") {
				for (var i = 0; i < rects.length; i++) if ((rect = rects[i]).left != rect.right) break;
			} else for (var i$1 = rects.length - 1; i$1 >= 0; i$1--) if ((rect = rects[i$1]).left != rect.right) break;
			return rect;
		}
		...
		function widgetTopHeight(lineObj) {
			var widgets = visualLine(lineObj).widgets;
			var height = 0;
			if (widgets) {
		...
		function cursorCoords(cm, pos, context, lineObj, preparedMeasure, varHeight) {
			...
			function getBidi(ch, partPos, invert) {
				var right = order[partPos].level == 1;
		...
		function coordsBidiPartWrapped(cm, lineObj, _lineNo, preparedMeasure, order, x, y) {
			...
			for (var i = 0; i < order.length; i++) {
				...
				var endX = measureCharPrepared(cm, preparedMeasure, p.level != 1 ? Math.min(end, p.to) - 1 : Math.max(begin, p.from)).right;
		...
		function adjustView(cm, from, to) {
			var display = cm.display;
			if (display.view.length == 0 || from >= display.viewTo || to <= display.viewFrom) {
		...
		function drawSelectionRange(cm, range, output) {
			...
			function drawForLine(line, fromArg, toArg) {
				...
				function wrapX(pos, dir, side) {
					...
					return coords(side == "after" ? extent.begin : extent.end - (/\s/.test(lineObj.text.charAt(extent.end - 1)) ? 2 : 1), prop)[prop];
				}
		...
		function resolveScrollToPos(cm) {
			...
			if (range) {
				...
				scrollToCoordsRange(cm, estimateCoords(cm, range.from), estimateCoords(cm, range.to), range.margin);
			}
		}
		...
		NativeScrollbars.prototype.enableZeroWidthBar = function(bar, delay, type) {
			...
			function maybeDisable() {
				...
				if ((type == "vert" ? document.elementFromPoint(box.right - 1, (box.top + box.bottom) / 2) : document.elementFromPoint((box.right + box.left) / 2, box.bottom - 1)) != bar) bar.style.visibility = "hidden";
		...
		function endOperation_finish(op) {
			...
			if (op.scrollToPos) maybeScrollWindow(cm, scrollPosIntoView(cm, clipPos(doc, op.scrollToPos.from), clipPos(doc, op.scrollToPos.to), op.scrollToPos.margin));
		...
		function Display(place, doc, input, options) {
			...
			d.mover = elt("div", [eltP("div", [d.lineSpace], "CodeMirror-lines")], null, "position: relative");
		...
		function clearSelectionEvents(array) {
			while (array.length) if (lst(array).ranges) array.pop();
			else break;
		}
		...
		function addChangeToHistory(doc, change, selAfter, opId) {
			...
			if ((hist.lastOp == opId || hist.lastOrigin == change.origin && change.origin && (change.origin.charAt(0) == "+" && hist.lastModTime > time - (doc.cm ? doc.cm.options.historyEventDelay : 500) || change.origin.charAt(0) == "*")) && (cur = lastChangeEvent(hist, hist.lastOp == opId))) {
				...
				else cur.changes.push(historyChangeFromChange(doc, change));
			} else {
		...
		function removeClearedSpans(spans) {
			...
			var out;
			for (var i = 0; i < spans.length; ++i) if (spans[i].marker.explicitlyCleared) {
		...
		function extendSelections(doc, heads, options) {
			...
			setSelection(doc, normalizeSelection(doc.cm, out, doc.sel.primIndex), options);
		}
		...
		function movePos(doc, pos, dir, line) {
			if (dir < 0 && pos.ch == 0) if (pos.line > doc.first) return clipPos(doc, Pos(pos.line - 1));
			else return null;
			else if (dir > 0 && pos.ch == (line || getLine(doc, pos.line)).text.length) if (pos.line < doc.first + doc.size - 1) return Pos(pos.line + 1, 0);
			else return null;
		...
		function makeChangeFromHistory(doc, type, allowSelectionOnly) {
			...
			var loop = function(i) {
				...
				makeChangeSingleDoc(doc, change, i ? computeSelAfterChange(doc, change) : lst(source), mergeOldSpans(doc, change));
		...
		TextMarker.prototype.changed = function() {
			...
			runInOp(cm, function() {
				var line = pos.line;
				var view = findViewForLine(cm, lineNo(pos.line));
				if (view) {
		...
		Doc.prototype = createObj(BranchChunk.prototype, {
			...
			unlinkDoc: function(other) {
				...
				if (this.linked) for (var i = 0; i < this.linked.length; ++i) {
					if (this.linked[i].doc != other) continue;
		...
		function onDrop(e) {
			...
			e_preventDefault(e);
			if (ie) lastDrop = +/* @__PURE__ */ new Date();
		...
		function endOfLine(visually, cm, lineObj, lineNo, dir) {
			if (visually) {
				...
				if (order) {
					...
					var sticky = dir < 0 == (part.level == 1) ? "after" : "before";
					var ch;
		...
		function dispatchKey(cm, name, e, handle) {
			...
			if (seq) {
				...
				if (name.endsWith('\'')) cm.state.keySeq = null;
		...
		function configureMouse(cm, repeat, event) {
			...
			if (value.unit == null) value.unit = (chromeOS ? event.shiftKey && event.metaKey : event.altKey) ? "rectangle" : repeat == "single" ? "char" : repeat == "double" ? "word" : "line";
		...
		function indentLine(cm, n, how, aggressive) {
			...
			if (indentString != curSpaceString) {
				...
				return true;
			} else for (var i$1 = 0; i$1 < doc.sel.ranges.length; i$1++) {
		...
		function posToDOM(cm, pos) {
			...
			if (order) side = getBidiPartAt(order, pos.ch) % 2 ? "right" : "left";
		...
		TextareaInput.prototype.init = function(display) {
			...
			function prepareCopyCut(e) {
				...
				if (e.type == "cut") cm.state.cutIncoming = +/* @__PURE__ */ new Date();
			}
		...
		TextareaInput.prototype.onContextMenu = function(e) {
			...
			if (cm.options.resetSelectionOnContextMenu && cm.doc.sel.contains(pos) == -1) operation(cm, setSelection)(cm.doc, simpleSelection(pos), sel_dontScroll);
...
//#endregion
//#region node_modules/.pnpm/codemirror@5.65.20/node_modules/codemirror/addon/dialog/dialog.js
...
//#endregion
//#region node_modules/.pnpm/codemirror@5.65.20/node_modules/codemirror/addon/dialog/dialog.css
var import_codemirror = /* @__PURE__ */ __toESM(require_codemirror(), 1);
require_dialog();
//#endregion
//#region node_modules/.pnpm/codemirror@5.65.20/node_modules/codemirror/addon/display/placeholder.js
...
//#endregion
//#region node_modules/.pnpm/codemirror@5.65.20/node_modules/codemirror/addon/search/jump-to-line.js
var require_jump_to_line = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	(function(mod) {
...
//#endregion
//#region node_modules/.pnpm/codemirror@5.65.20/node_modules/codemirror/addon/search/searchcursor.js
var require_searchcursor = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	(function(mod) {
		if (typeof exports == "object" && typeof module == "object") mod(require_codemirror());
		else if (typeof define == "function" && define.amd) define(["../../lib/codemirror"], mod);
		else mod(CodeMirror);
...
//#endregion
//#region node_modules/.pnpm/codemirror@5.65.20/node_modules/codemirror/addon/search/search.js
var require_search = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	(function(mod) {
		...
		function replace(cm, all) {
			...
			dialog(cm, el("", null, el("span", { className: "CodeMirror-search-label" }, dialogText), getReplaceQueryDialog(cm)), dialogText, query, function(query) {
				if (!query) return;
...
require_search();
//#endregion
//#region node_modules/.pnpm/codemirror@5.65.20/node_modules/codemirror/mode/css/css.js
...
//#endregion
//#region node_modules/.pnpm/codemirror@5.65.20/node_modules/codemirror/addon/mode/simple.js
var require_simple = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	(function(mod) {
		if (typeof exports == "object" && typeof module == "object") mod(require_codemirror());
		else if (typeof define == "function" && define.amd) define(["../../lib/codemirror"], mod);
		else mod(CodeMirror);
...
//#endregion
//#region node_modules/.pnpm/codemirror@5.65.20/node_modules/codemirror/addon/mode/multiplex.js
var require_multiplex = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	(function(mod) {
		if (typeof exports == "object" && typeof module == "object") mod(require_codemirror());
		else if (typeof define == "function" && define.amd) define(["../../lib/codemirror"], mod);
		else mod(CodeMirror);
...
//#endregion
//#region node_modules/.pnpm/codemirror@5.65.20/node_modules/codemirror/mode/handlebars/handlebars.js
...
//#endregion
//#region node_modules/.pnpm/codemirror@5.65.20/node_modules/codemirror/mode/xml/xml.js
...
//#endregion
//#region node_modules/.pnpm/codemirror@5.65.20/node_modules/codemirror/mode/javascript/javascript.js
...
//#endregion
//#region node_modules/.pnpm/codemirror@5.65.20/node_modules/codemirror/mode/htmlmixed/htmlmixed.js
var require_htmlmixed = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	(function(mod) {
		...
		CodeMirror.defineMode("htmlmixed", function(config, parserConfig) {
			...
			function html(stream, state) {
				...
				else if (state.inTag && tag && stream.current().endsWith('>')) {
			...
			return {
				...
				copyState: function(state) {
					var local;
					if (state.localState) local = CodeMirror.copyState(state.localMode, state.localState);
					return {
						token: state.token,
						inTag: state.inTag,
...
//#endregion
//#region node_modules/.pnpm/codemirror@5.65.20/node_modules/codemirror/mode/meta.js
var require_meta = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	(function(mod) {
		...
		CodeMirror.findModeByMIME = function(mime) {
			...
			if (mime.endsWith('+xml')) return CodeMirror.findModeByMIME("application/xml");
			if (mime.endsWith('+json')) return CodeMirror.findModeByMIME("application/json");
		};
...
//#endregion
//#region node_modules/.pnpm/codemirror@5.65.20/node_modules/codemirror/mode/markdown/markdown.js
	...
	(function(mod) {
		...
		CodeMirror.defineMode("markdown", function(cmCfg, modeCfg) {
			...
			function inlineNormal(stream, state) {
				...
				if (state.taskList) {
					if (stream.match(taskListRE, true)[1] === " ") state.taskOpen = true;
...
//#endregion
//#region node_modules/.pnpm/codemirror@5.65.20/node_modules/codemirror/mode/pug/pug.js
		...
		CodeMirror.defineMode("pug", function(config) {
			...
			*/
			State.prototype.copy = function() {
				...
				if (this.innerMode && this.innerState) res.innerState = CodeMirror.copyState(this.innerMode, this.innerState);
			...
			function filter(stream, state) {
				if (stream.match(/^:([\w-]+)/)) {
					var innerMode;
					if (config && config.innerModes) innerMode = config.innerModes(stream.current().substring(1));
			...
			function dot(stream, state) {
				if (stream.eat(".")) {
					var innerMode = null;
					if (state.lastTag === "script" && state.scriptType.toLowerCase().indexOf("javascript") != -1) innerMode = state.scriptType.toLowerCase().replace(/"|'/g, "");
					else if (state.lastTag === "style") innerMode = "css";
					setInnerMode(stream, state, innerMode);
					return "dot";
				}
			}
			...
			function innerMode(stream, state, force) {
				if (stream.indentation() > state.indentOf || state.innerModeForLine && !stream.sol() || force) if (state.innerMode) {
					if (!state.innerState) state.innerState = state.innerMode.startState ? CodeMirror.startState(state.innerMode, stream.indentation()) : {};
...
//#endregion
//#region node_modules/.pnpm/codemirror@5.65.20/node_modules/codemirror/mode/sass/sass.js
var require_sass = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	(function(mod) {
		...
		CodeMirror.defineMode("sass", function(config) {
			...
			function indent(state) {
				if (state.indentCount == 0) {
					state.indentCount++;
					var currentOffset = state.scopes[0].offset + config.indentUnit;
			...
			function tokenLexer(stream, state) {
				...
				if (style !== null) {
					var withCurrentIndent = stream.pos - current.length + config.indentUnit * state.indentCount;
					var newScopes = [];
...
//#endregion
//#region node_modules/.pnpm/codemirror@5.65.20/node_modules/codemirror/addon/mode/overlay.js
var require_overlay = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	(function(mod) {
		if (typeof exports == "object" && typeof module == "object") mod(require_codemirror());
		else if (typeof define == "function" && define.amd) define(["../../lib/codemirror"], mod);
		else mod(CodeMirror);
...
//#endregion
//#region node_modules/.pnpm/codemirror@5.65.20/node_modules/codemirror/mode/coffeescript/coffeescript.js
...
//#endregion
//#region node_modules/.pnpm/codemirror@5.65.20/node_modules/codemirror/mode/stylus/stylus.js
		...
		CodeMirror.defineMode("stylus", function(config) {
			...
			*/
			states.keyframes = function(type, stream, state) {
				...
				if (type == "}") if (startOfLine(stream)) return popContext(state, true);
			...
			*/
			...
			return {
				...
				indent: function(state, textAfter, line) {
					...
					if (cx.prev && (ch == "}" && (cx.type == "block" || cx.type == "atBlock" || cx.type == "keyframes") || ch == ")" && (cx.type == "parens" || cx.type == "atBlock_parens") || ch == "{" && cx.type == "at")) indent = cx.indent - indentUnit;
					else if (!/(\})/.test(ch)) {
						if (/@|\$|\d/.test(ch) || textAfter.startsWith('{') || /^\s*\/(\/|\*)/.test(textAfter) || /^\s*\/\*/.test(prevLineFirstWord) || /^\s*[\w-.\[\]'\"]+\s*(\?|:|\+)?=/i.test(textAfter) || /^(\+|-)?[a-z][\w-]*\(/i.test(textAfter) || textAfter.startsWith('return') || wordIsBlock(lineFirstWord)) indent = lineIndent;
						...
						else if (prevLineFirstWord.startsWith('{')) indent = lineIndent <= prevLineIndent ? lineIndent : prevLineIndent + indentUnit;
...
//#endregion
//#region node_modules/.pnpm/codemirror@5.65.20/node_modules/codemirror/mode/vue/vue.js
var require_vue = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	(function(mod) {
		...
		CodeMirror.defineMode("vue-template", function(config, parserConfig) {
			return CodeMirror.overlayMode(CodeMirror.getMode(config, parserConfig.backdrop || "text/html"), { token: function(stream) {
...
//#endregion
//#region src/client/worker/diff.ts
var diffWorker;
async function calculateDiffWithWorker(left, right) {
	if (!diffWorker) diffWorker = wrap(new Worker(new URL(
		/* @vite-ignore */
		"" + new URL("diff.worker-SmwPJZl6.js", import.meta.url).href,
		"" + import.meta.url
	), { type: "module" }));
	return await diffWorker.calculateDiff(left, right);
}
//#endregion
//#region src/client/components/DiffEditor.vue
var DiffEditor_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		onMounted(() => {
			...
			watchEffect(async () => {
				...
				if (diffEnabled && from.value) {
					...
					const removedLines = /* @__PURE__ */ new Set();
					let indexL = 0;
					let indexR = 0;
		...
		return (_ctx, _cache) => {
			return openBlock(), createBlock(unref(y), { onResize: _cache[0] || (_cache[0] = ($event) => onUpdate($event.prevPane.size)) }, {
				default: withCtx(() => [withDirectives(createVNode(unref(b), {
					"min-size": "10",
					...
					_: 1
				}, 8, ["size"]), [[vShow, !__props.oneColumn]]), createVNode(unref(b), {
					"min-size": "10",
...
//#endregion
//#region src/client/components/ErrorDisplay.vue?vue&type=script&setup=true&lang.ts
var _hoisted_1$1 = {
	"of-auto": "",
	p4: "",
	"font-mono": "",
...
var _hoisted_5$1 = { "ws-nowrap": "" };
//#endregion
//#region src/client/components/ErrorDisplay.vue
var ErrorDisplay_default = /* @__PURE__ */ defineComponent({
	__name: "ErrorDisplay",
	props: { error: {} },
	setup(__props) {
		...
		return (_ctx, _cache) => {
			...
			return openBlock(), createElementBlock("div", _hoisted_1$1, [
				...
				createBaseVNode("pre", _hoisted_2$1, toDisplayString(__props.error.message), 1),
				_cache[1] || (_cache[1] = createBaseVNode("div", {
					border: "t main",
					"h-1px": "",
					"w-full": ""
				}, null, -1)),
				createBaseVNode("div", _hoisted_3$1, [(openBlock(true), createElementBlock(Fragment, null, renderList(__props.error.stack, (item, idx) => {
...
//#endregion
//#region node_modules/.pnpm/@vueuse+router@14.3.0_vue-router@5.1.0_@vue+compiler-sfc@3.5.35_pinia@3.0.4_typescript@_dd464cd684e5149080b6310bbd30521d/node_modules/@vueuse/router/dist/index.js
...
//#endregion
//#region src/client/pages/index/module.vue?vue&type=script&setup=true&lang.ts
var _hoisted_1 = {
	title: "Dependencies",
	flex: "~ gap-2 items-center",
	"icon-btn": "",
...
var _hoisted_2 = { "line-height-1em": "" };
var _hoisted_3 = {
	"max-h-400": "",
	"max-w-200": "",
	"of-auto": ""
...
var _hoisted_5 = { "line-height-1em": "" };
var _hoisted_6 = {
	"max-h-400": "",
	"max-w-200": "",
	"of-auto": ""
};
var _hoisted_7 = ["title", "disabled"];
var _hoisted_8 = {
	key: 0,
...
//#endregion
//#region src/client/pages/index/module.vue
var module_default = /* @__PURE__ */ defineComponent({
	__name: "module",
	async setup(__props) {
		...
		const sourcemaps = computed(() => {
			...
			if (!sourcemaps) return void 0;
			if (typeof sourcemaps === "string") sourcemaps = safeJsonParse(sourcemaps);
			if (!sourcemaps?.mappings) return;
			if (sourcemaps && !sourcemaps.sourcesContent?.filter(Boolean)?.length) sourcemaps.sourcesContent = [from.value];
			if (sourcemaps && !sourcemaps.sources?.filter(Boolean)?.length) sourcemaps.sources = ["index.js"];
			...
			return openBlock(), createElementBlock(Fragment, null, [createVNode(_component_NavBar, null, {
				...
				default: withCtx(() => [createVNode(unref(y), {
					...
					default: withCtx(() => [createVNode(unref(b), {
						...
						_: 1
					}, 8, ["size"]), createVNode(unref(b), { "min-size": "5" }, {
