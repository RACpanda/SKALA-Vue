...
var loadBuiltinPluginsWithoutCache = true ? async () => (await Promise.resolve().then(() => (init_production_plugins(), production_plugins_exports))).plugins : async () => (null).plugins;
var cache2;
