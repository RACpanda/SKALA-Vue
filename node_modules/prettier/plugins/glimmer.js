(function(f){function e(){var i=f();return i.default||i}if(typeof exports=="object"&&typeof module=="object")module.exports=e();else if(typeof define=="function"&&define.amd)define(e);else{var t=typeof globalThis<"u"?globalThis:typeof global<"u"?global:typeof self<"u"?self:this||{};t.prettierPlugins=t.prettierPlugins||{},t.prettierPlugins.glimmer=e()}})(function(){"use strict";var Oe=Object.defineProperty;var Mn=Object.getOwnPropertyDescriptor;var zn=Object.getOwnPropertyNames;var Yn=Object.prototype.hasOwnProperty;var Ie=(e,t)=>{for(var r in t)Oe(e,r,{get:t[r],enumerable:!0})},Gn=(e,t,r,s)=>{if(t&&typeof t=="object"||typeof t=="function")for(let n of zn(t))!Yn.call(e,n)&&n!==r&&Oe(e,n,{get:()=>t[n],enumerable:!(s=Mn(t,n))||s.enumerable});return e};var Kn=e=>Gn(Oe({},"__esModule",{value:!0}),e);var Oi={};Ie(Oi,{languages:()=>Dn,parsers:()=>kr,printers:()=>Di});var Jt=(e,t)=>(r,s,...n)=>r|1&&s==null?void 0:(t.call(s)??s[e]).apply(s,n);var Wn=String.prototype.replaceAll??function(e,t){return e.global?this.replace(e,t):this.split(e).join(t)},jn=Jt("replaceAll",function(){if(typeof this=="string")return Wn}),ct=jn;function Qn(e){return this[e<0?this.length+e:e]}var Jn=Jt("at",function(){if(Array.isArray(this)||typeof this=="string")return Qn}),V=Jn;var $n=()=>{},Dt=$n;var Ot="string",It="array",$t="cursor",kt="indent",Et="align",Xt="trim",vt="group",wt="fill",Tt="if-break",Zt="indent-if-break",te="line-suffix",ee="line-suffix-boundary",Q="line",re="label",Nt="break-parent",ne=new Set([$t,kt,Et,Xt,vt,wt,Tt,Zt,te,ee,Q,re,Nt]);function Dr(e,t,r){if(!e.has(t)){let s=r(t);e.set(t,s)}return e.get(t)}function Xn(e){if(typeof e=="string")return Ot;if(Array.isArray(e))return It;if(!e)return;let{type:t}=e;if(ne.has(t))return t}var se=Xn;var Zn=e=>new Intl.ListFormat("en-US",{type:"disjunction"}).format(e);function ts(e){let t=e===null?"null":typeof e;if(t!=="string"&&t!=="object")return`Unexpected doc '${t}', 
Expected it to be 'string' or 'object'.`;if(se(e))throw new Error("doc is valid.");let r=Object.prototype.toString.call(e);if(r!=="[object Object]")return`Unexpected doc '${r}'.`;let s=Zn([...ne].map(n=>`'${n}'`));return`Unexpected doc.type '${e.type}'.
Expected it to be ${s}.`}var Be=class extends Error{name="InvalidDocError";constructor(t){super(ts(t)),this.doc=t}},Or=Be;function es(e,t){if(typeof e=="string")return t(e);let r=new Map;return s(e);function s(i){return Dr(r,i,n)}function n(i){switch(se(i)){case It:return t(i.map(s));case wt:return t({...i,parts:i.parts.map(s)});case Tt:return t({...i,breakContents:s(i.breakContents),flatContents:s(i.flatContents)});case vt:{let{expandedStates:a,contents:o}=i;return a?(a=a.map(s),o=a[0]):o=s(o),t({...i,contents:o,expandedStates:a})}case Et:case kt:case Zt:case re:case te:return t({...i,contents:s(i.contents)});case Ot:case $t:case Xt:case ee:case Q:case Nt:return t(i);default:throw new Or(i)}}}function ie(e,t=Ir){return es(e,r=>typeof r=="string"?ut(t,r.split(`
`)):r)}var M=Dt,ae=Dt,Br=Dt,Rr=Dt;function F(e){return M(e),{type:kt,contents:e}}function rs(e,t){return Rr(e),M(t),{type:Et,contents:t,n:e}}function Re(e){return rs(-1,e)}var qe={type:Nt};function Ve(e){return Br(e),{type:wt,parts:e}}function I(e,t={}){return M(e),ae(t.expandedStates,!0),{type:vt,id:t.id,contents:e,break:!!t.shouldBreak,expandedStates:t.expandedStates}}function Fe(e,t="",r={}){return M(e),t!==""&&M(t),{type:Tt,breakContents:e,flatContents:t,groupId:r.groupId}}function ut(e,t){M(e),ae(t);let r=[];for(let s=0;s<t.length;s++)s!==0&&r.push(e),r.push(t[s]);return r}var x={type:Q},H={type:Q,soft:!0},ns={type:Q,hard:!0},ht=[ns,qe],ss={type:Q,hard:!0,literal:!0},Ir=[ss,qe];var qr=Object.freeze({character:"'",codePoint:39}),Vr=Object.freeze({character:'"',codePoint:34}),is=Object.freeze({preferred:qr,alternate:Vr}),as=Object.freeze({preferred:Vr,alternate:qr});function oe(e,t){let{preferred:r,alternate:s}=t===!0||t==="'"?is:as,{length:n}=e,i=0,a=0;for(let o=0;o<n;o++){let c=e.charCodeAt(o);c===r.codePoint?i++:c===s.codePoint&&a++}return(i>a?s:r).character}function He(e){if(typeof e!="string")throw new TypeError("Expected a string");return e.replace(/[|\\{}()[\]^$+*?.]/g,"\\$&").replace(/-/g,"\\x2d")}var Ue=class{#t;constructor(t){this.#t=new Set(t)}getLeadingWhitespaceCount(t){let r=this.#t,s=0;for(let n=0;n<t.length&&r.has(t.charAt(n));n++)s++;return s}getTrailingWhitespaceCount(t){let r=this.#t,s=0;for(let n=t.length-1;n>=0&&r.has(t.charAt(n));n--)s++;return s}getLeadingWhitespace(t){let r=this.getLeadingWhitespaceCount(t);return t.slice(0,r)}getTrailingWhitespace(t){let r=this.getTrailingWhitespaceCount(t);return t.slice(t.length-r)}hasLeadingWhitespace(t){return this.#t.has(t.charAt(0))}hasTrailingWhitespace(t){return this.#t.has(V(0,t,-1))}trimStart(t){let r=this.getLeadingWhitespaceCount(t);return t.slice(r)}trimEnd(t){let r=this.getTrailingWhitespaceCount(t);return t.slice(0,t.length-r)}trim(t){return this.trimEnd(this.trimStart(t))}split(t,r=!1){let s=`[${He([...this.#t].join(""))}]+`,n=new RegExp(r?`(${s})`:s);return t.split(n)}hasWhitespaceCharacter(t){let r=this.#t;return Array.prototype.some.call(t,s=>r.has(s))}hasNonWhitespaceCharacter(t){let r=this.#t;return Array.prototype.some.call(t,s=>!r.has(s))}isWhitespaceOnly(t){let r=this.#t;return Array.prototype.every.call(t,s=>r.has(s))}#e(t){let r=Number.POSITIVE_INFINITY;for(let s of t.split(`
