var Mn=Object.defineProperty;var Oe=(e,t)=>{for(var r in t)Mn(e,r,{get:t[r],enumerable:!0})};var Rn={};Oe(Rn,{languages:()=>Ln,parsers:()=>Sr,printers:()=>Pi});var Jt=(e,t)=>(r,s,...n)=>r|1&&s==null?void 0:(t.call(s)??s[e]).apply(s,n);var zn=String.prototype.replaceAll??function(e,t){return e.global?this.replace(e,t):this.split(e).join(t)},Yn=Jt("replaceAll",function(){if(typeof this=="string")return zn}),ct=Yn;function Gn(e){return this[e<0?this.length+e:e]}var Kn=Jt("at",function(){if(Array.isArray(this)||typeof this=="string")return Gn}),V=Kn;var Wn=()=>{},Dt=Wn;var Ot="string",It="array",$t="cursor",kt="indent",Et="align",Xt="trim",vt="group",wt="fill",Tt="if-break",Zt="indent-if-break",te="line-suffix",ee="line-suffix-boundary",Q="line",re="label",xt="break-parent",ne=new Set([$t,kt,Et,Xt,vt,wt,Tt,Zt,te,ee,Q,re,xt]);function Lr(e,t,r){if(!e.has(t)){let s=r(t);e.set(t,s)}return e.get(t)}function jn(e){if(typeof e=="string")return Ot;if(Array.isArray(e))return It;if(!e)return;let{type:t}=e;if(ne.has(t))return t}var se=jn;var Qn=e=>new Intl.ListFormat("en-US",{type:"disjunction"}).format(e);function Jn(e){let t=e===null?"null":typeof e;if(t!=="string"&&t!=="object")return`Unexpected doc '${t}', 
Expected it to be 'string' or 'object'.`;if(se(e))throw new Error("doc is valid.");let r=Object.prototype.toString.call(e);if(r!=="[object Object]")return`Unexpected doc '${r}'.`;let s=Qn([...ne].map(n=>`'${n}'`));return`Unexpected doc.type '${e.type}'.
Expected it to be ${s}.`}var Ie=class extends Error{name="InvalidDocError";constructor(t){super(Jn(t)),this.doc=t}},Dr=Ie;function $n(e,t){if(typeof e=="string")return t(e);let r=new Map;return s(e);function s(i){return Lr(r,i,n)}function n(i){switch(se(i)){case It:return t(i.map(s));case wt:return t({...i,parts:i.parts.map(s)});case Tt:return t({...i,breakContents:s(i.breakContents),flatContents:s(i.flatContents)});case vt:{let{expandedStates:a,contents:o}=i;return a?(a=a.map(s),o=a[0]):o=s(o),t({...i,contents:o,expandedStates:a})}case Et:case kt:case Zt:case re:case te:return t({...i,contents:s(i.contents)});case Ot:case $t:case Xt:case ee:case Q:case xt:return t(i);default:throw new Dr(i)}}}function ie(e,t=Or){return $n(e,r=>typeof r=="string"?ut(t,r.split(`
`)):r)}var M=Dt,ae=Dt,Ir=Dt,Br=Dt;function F(e){return M(e),{type:kt,contents:e}}function Xn(e,t){return Br(e),M(t),{type:Et,contents:t,n:e}}function Be(e){return Xn(-1,e)}var Re={type:xt};function qe(e){return Ir(e),{type:wt,parts:e}}function I(e,t={}){return M(e),ae(t.expandedStates,!0),{type:vt,id:t.id,contents:e,break:!!t.shouldBreak,expandedStates:t.expandedStates}}function Ve(e,t="",r={}){return M(e),t!==""&&M(t),{type:Tt,breakContents:e,flatContents:t,groupId:r.groupId}}function ut(e,t){M(e),ae(t);let r=[];for(let s=0;s<t.length;s++)s!==0&&r.push(e),r.push(t[s]);return r}var N={type:Q},H={type:Q,soft:!0},Zn={type:Q,hard:!0},ht=[Zn,Re],ts={type:Q,hard:!0,literal:!0},Or=[ts,Re];var Rr=Object.freeze({character:"'",codePoint:39}),qr=Object.freeze({character:'"',codePoint:34}),es=Object.freeze({preferred:Rr,alternate:qr}),rs=Object.freeze({preferred:qr,alternate:Rr});function oe(e,t){let{preferred:r,alternate:s}=t===!0||t==="'"?es:rs,{length:n}=e,i=0,a=0;for(let o=0;o<n;o++){let c=e.charCodeAt(o);c===r.codePoint?i++:c===s.codePoint&&a++}return(i>a?s:r).character}function Fe(e){if(typeof e!="string")throw new TypeError("Expected a string");return e.replace(/[|\\{}()[\]^$+*?.]/g,"\\$&").replace(/-/g,"\\x2d")}var He=class{#t;constructor(t){this.#t=new Set(t)}getLeadingWhitespaceCount(t){let r=this.#t,s=0;for(let n=0;n<t.length&&r.has(t.charAt(n));n++)s++;return s}getTrailingWhitespaceCount(t){let r=this.#t,s=0;for(let n=t.length-1;n>=0&&r.has(t.charAt(n));n--)s++;return s}getLeadingWhitespace(t){let r=this.getLeadingWhitespaceCount(t);return t.slice(0,r)}getTrailingWhitespace(t){let r=this.getTrailingWhitespaceCount(t);return t.slice(t.length-r)}hasLeadingWhitespace(t){return this.#t.has(t.charAt(0))}hasTrailingWhitespace(t){return this.#t.has(V(0,t,-1))}trimStart(t){let r=this.getLeadingWhitespaceCount(t);return t.slice(r)}trimEnd(t){let r=this.getTrailingWhitespaceCount(t);return t.slice(0,t.length-r)}trim(t){return this.trimEnd(this.trimStart(t))}split(t,r=!1){let s=`[${Fe([...this.#t].join(""))}]+`,n=new RegExp(r?`(${s})`:s);return t.split(n)}hasWhitespaceCharacter(t){let r=this.#t;return Array.prototype.some.call(t,s=>r.has(s))}hasNonWhitespaceCharacter(t){let r=this.#t;return Array.prototype.some.call(t,s=>!r.has(s))}isWhitespaceOnly(t){let r=this.#t;return Array.prototype.every.call(t,s=>r.has(s))}#e(t){let r=Number.POSITIVE_INFINITY;for(let s of t.split(`
...
`)),V(0,h,-1).length}},[In]:!0}}function Si(e){let t=yi(e);return t?{frontMatter:t,get content(){let{raw:r}=t;return On(r)+e.slice(r.length)}}:{content:e}}var Bn=Si;function ki(e){let t=e.children??e.body;if(t)for(let r=0;r<t.length-1;r++)t[r].type==="TextNode"&&t[r+1].type==="MustacheStatement"&&(t[r].chars=t[r].chars.replace(/\\$/,"\\\\"))}var Ei=e=>{let{start:t,end:r}=e.loc;t.offset=e.loc.getStart().offset,r.offset=e.loc.getEnd().offset},vi=()=>({name:"glimmerPrettierParsePlugin",visitor:{All(e){Ei(e),ki(e)}}}),wi={mode:"codemod",plugins:{ast:[vi]}};function Ti(e){let{frontMatter:t,content:r}=Bn(e),s;try{s=mn(r,wi)}catch(n){let i=Ni(n);if(i){let a=xi(n);throw Dn(a,{loc:i,cause:n})}throw n}if(t){let n={...t,type:"FrontMatter",loc:{start:{...t.start,offset:t.start.index},end:{...t.end,offset:t.end.index}}};s.body.unshift(n)}return s}function xi(e){let{message:t}=e,r=t.split(`
`);return r.length>=4&&/^Parse error on line \d+:$/.test(r[0])&&/^-*\^$/.test(V(0,r,-2))?V(0,r,-1):r.length>=4&&/:\s?$/.test(r[0])&&/^\(error occurred in '.*?' @ line \d+ : column \d+\)$/.test(V(0,r,-1))&&r[1]===""&&V(0,r,-2)===""&&r.slice(2,-2).every(s=>s.startsWith("|"))?r[0].trim().slice(0,-1):t}function Ni(e){let{location:t,hash:r}=e;if(t){let{start:s,end:n}=t;return{start:{line:s.line,column:s.column+1},end:typeof n.line=="number"?{line:n.line,column:n.column+1}:void 0}}if(r){let{loc:{last_line:s,last_column:n}}=r;return{start:{line:s,column:n+1}}}}var Ai={parse:Ti,astFormat:"glimmer",locStart:dt,locEnd:Gt};var Pi={glimmer:_n};export{Rn as default,Ln as languages,Sr as parsers,Pi as printers};
