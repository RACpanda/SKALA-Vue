...
@layer vuetify-components {
  ...
  .v-progress-linear--rounded-bar .v-progress-linear__buffer,
  ...
  .v-progress-linear--rounded-bar.v-progress-linear--reverse .v-progress-linear__determinate,
  .v-progress-linear--rounded-bar.v-progress-linear--reverse .v-progress-linear__buffer {
    border-radius: 9999px 0 0 9999px;
  }
  .v-progress-linear--rounded.v-progress-linear--rounded-bar .v-progress-linear__determinate,
  .v-progress-linear--rounded.v-progress-linear--rounded-bar .v-progress-linear__indeterminate,
  .v-progress-linear--rounded.v-progress-linear--rounded-bar .v-progress-linear__buffer {
    border-radius: inherit;
  }
